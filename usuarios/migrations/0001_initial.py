    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token_confirmacao', models.CharField(blank=True, max_length=64, null=True)),
                ('token_recuperacao', models.CharField(blank=True, max_length=64, null=True)),
                ('token_recuperacao_expira', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.AddConstraint(
            model_name='usuario',
            constraint=models.UniqueConstraint(django.db.models.functions.text.Lower('email'), name='usuario_email_sem_maiusculas'),
        ),
    ]
